...
{
  TimerOutput::Scope t(computing_timer, "grid generator");
...
{
  TimerOutput::Scope t(computing_timer, "solver");
...
{ 
  TimerOutput::Scope t(computing_timer, "generate random field");
...
{
  TimerOutput::Scope t(computing_timer, "statistics for random field");
...
{
  //TimerOutput::Scope t(computing_timer, "generate output files");
